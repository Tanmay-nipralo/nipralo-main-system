                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    <div class="row">
                                            ...
                                            <div class="input-block mb-3">
                                                ...
                                                <select class="select" name="reference">
                                                    ...
                                                    <option value="select" <?php if (isset($idd)) {
                                                                                echo $user['reference'] == 'manual' ? "selected" : '';
                                                                            } ?>>Manual</option>
                                                    <option value="google" <?php if (isset($idd)) {
                                                                                echo $user['reference'] == 'google' ? "selected" : '';
                                                                            } ?>>Google</option>
                                                    <option value="website" <?php if (isset($idd)) {
                                                                                echo $user['reference'] == 'website' ? "selected" : '';
                                                                            } ?>>Website</option>
                                                    <option value="friendRelative" <?php if (isset($idd)) {
                                                                                        echo $user['reference'] == 'friendRelative' ? "selected" : '';
                                                                                    } ?>>Friend/Relative</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3">
                                                ...
                                                <select class="select" name="position">
                                                    ...
                                                    <option value="Fronted Developer" <?php if (isset($idd)) {
                                                                                            echo $user['position'] == 'Fronted Developer' ? "selected" : '';
                                                                                        } ?>>Fronted Developer</option>
                                                    <option value="Backend Developer" <?php if (isset($idd)) {
                                                                                            echo $user['position'] == 'Backend Developer' ? "selected" : '';
                                                                                        } ?>>Backend Developer</option>
                                                    <option value="Admin" <?php if (isset($idd)) {
                                                                                echo $user['position'] == 'Admin' ? "selected" : '';
                                                                            } ?>>Admin</option>
                                                    <option value="UI/UX Designer" <?php if (isset($idd)) {
                                                                                        echo $user['position'] == 'UI/UX Designer' ? "selected" : '';
                                                                                    } ?>>UI/UX Designer</option>
                                                    <option value="Graphic Designer" <?php if (isset($idd)) {
                                                                                            echo $user['position'] == 'Graphic Designer' ? "selected" : '';
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-block mb-3">
                                                <label class="col-form-label" for="mail">Skills </label>
                                                <textarea class="form-control" name="skills"><?php echo isset($idd) ? $user['skills'] : ''; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-block mb-3">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input type="radio" id="experience" name="jobtype" value="experience" <?php if (isset($user['jobtype']) && $user['jobtype'] == 'experience') echo 'checked'; ?> onclick="toggleSalaryField()">

                                            <label class="col-form-label" for="fresher">Fresher</label>
                                            <input type="radio" id="fresher" name="jobtype" value="fresher" <?php if (isset($user['jobtype']) && $user['jobtype'] == 'fresher') echo 'checked'; ?> onclick="toggleSalaryField()">
                                        </div>
                                        <div id="salaryField" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-block mb-3">
                                                        <label class="col-form-label" for="mail">Experience (no. of Years)</label>
                                                        <input class="form-control" type="text" name="exp_years" value="<?php echo isset($idd) ? $user['exp_years'] : ''; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
if (isset($_POST['add'])) {
    ...
    $exp_years = mysqli_real_escape_string($conn, $_POST['exp_years']);
    ...
    if (isset($idd)) {
        ...
        $validation = "SELECT * FROM sale WHERE (mobile_number = '$number' or email = '$email') AND status = 1";
        $sql_result = mysqli_query($conn, $validation);

        if (mysqli_num_rows($sql_result) === 0) {
            $sql = "INSERT INTO sale (name, mobile_number, email, reference,address, image, jobtype, organisation_name, job_title, salary_received, leave_reason, join_day, expected_salary, reason_forhiring, created_at, updated_at,position,exp_years,skills) VALUES ('$name', '$number', '$email', '$reference','$address', '$fimagee', '$jobtype', '$organisation_name', '$job_title', '$salary_received', '$leave_reason', '$join_day', '$expected_salary', '$reason_forhiring', '$created_time', '$created_time','$position','$exp_years','$skills')";
...
?>
        <script>
            toastr.success('<?= isset($idd) ? "Updated Successfully!" : "Added Successfully!"?>');
            setTimeout(function() {
                window.location = "<?php echo isset($idd) ? "edit_career.php?id=$idd" : "career.php"; ?>";
            }, 1000);
        </script>
