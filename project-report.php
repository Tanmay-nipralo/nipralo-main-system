										...
										<table class="table table-bordered custom-table datatable" >
											...
											<tbody>
												...
												<tr>
													...
													<td><?php
													$tasks = getAllProjecttask($project['id']);
													//  echo $project['id'];
													//  echo "<br>";
														echo isset($tasks['count'])? $tasks['count'] : 'No Tasks';
													 ?></td>
													<td><?php
													$subtasks = getAllSubtaskByProjectId($project['id']);
														echo isset($subtasks['count'])? $subtasks['count'] : 'No Tasks';
													?></td>
													<td><?php 
														// echo "<pre>";
							...
							<form method="post" enctype="multipart/form-data">
									...
									<div class="input-block mb-3">
											...
											<?php if (!$project1) {
												...
												echo '<img src="' . $project1['project_document'] . '" style="height:50px;">';
											} ?>
										</div>
